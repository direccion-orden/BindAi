...
async function testPrices() {
    let res = await fetch(`${API_BASE}/Products/a045009b-3722-40fb-a3b2-00002d005f59`, { headers });
    if(res.ok) {
        console.log("Product:", await res.json());
    } else {
        console.log("Product fetch failed", res.status);
    }
}
