                  ...
                  <div className="p-2 flex-1 flex flex-col">
                     ...
                     <div className="flex items-end justify-between mt-1">
                         <span className="font-bold text-primary text-xs">
                             {new Intl.NumberFormat('es-MX', { style: 'currency', currency: 'MXN', minimumFractionDigits: 0, maximumFractionDigits: 0 }).format(product.price || 0)}
                         </span>
                     </div>
                  </div>
                </div>
                   ...
                   >
                     ...
                     <div className="flex items-center gap-3">
                       <span className="font-bold text-primary">
                         {new Intl.NumberFormat('es-MX', { style: 'currency', currency: 'MXN', minimumFractionDigits: 0, maximumFractionDigits: 0 }).format(v.price || 0)}
                       </span>
                       <button
                         onClick={() => {
